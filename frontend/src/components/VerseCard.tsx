...
// The day's verse, first thing on the board. The whole card is a link that
// opens the passage on Bible.com (NKJV), which hands off to the YouVersion
// app when it's installed. Text shown here is KJV bundled with the app, so
// the card renders offline and phones home to no one.
export function VerseCard() {
  ...
  return (
    <motion.a
      ...
      className="glass mb-4 block p-4"
      data-verse-card
    >
